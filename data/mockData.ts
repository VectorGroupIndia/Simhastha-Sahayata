...
export const MOCK_LOST_FOUND_REPORTS: LostFoundReport[] = [
    ...
    {
        id: 'RPT-VOL-RESOLVED-1',
        type: 'Found',
        category: 'Item',
        subCategory: 'Documents & Cards',
        itemName: 'Wallet with ID',
        description: 'Found a brown leather wallet near the Sector A help center.',
        lastSeen: 'Sector A Help Center',
        reportedBy: 'Anonymous Pilgrim',
        reportedById: 99,
        timestamp: '2024-07-28T14:00:00Z',
        status: 'Resolved',
        priority: 'Medium',
    ...
    {
        id: 'RPT-VOL-RESOLVED-2',
        type: 'Lost',
        category: 'Person',
        personName: 'Rohan Sharma',
        personAge: '9',
        personGender: 'Male',
        clothingAppearance: 'Yellow T-shirt, blue jeans.',
        description: 'A young boy was found looking for his parents near the bridge and has been reunited with them.',
        lastSeen: 'Bridge near Ram Ghat',
        reportedBy: 'Officer Singh (Authority)',
        reportedById: 4,
  ...
  en: {
    ...
    profile: {
        ...
        volunteer: {
            ...
            resolvedHistoryTitle: "Resolved Case History",
            noResolvedCases: "You have no resolved cases yet.",
