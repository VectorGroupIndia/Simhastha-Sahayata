...
export const DEMO_USERS: User[] = [
  ...
  { id: 3, name: 'Admin User', role: UserRole.ADMIN, avatar: 'https://picsum.photos/seed/admin/100/100', status: 'Active', emergencyContacts: [], settings: { notifications: true, powerButtonSos: false, voiceNav: false, theme: 'light' } },
